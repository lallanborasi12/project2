...
import { men_images } from "../../config/imagedata/pages/men_images";
  ...
  return (
    <div className="min-ht">
      ...
      <div className="bodly">
        ...
        <div className="tit">
          <h1>Personalized Keto Diet for Men Get Yours Now</h1>
        </div>
