...
import { over40_images } from "../../config/imagedata/pages/over40_images";
...
const Over40 = () => {
  ...
  // const over40_images = useMemo(() => over40_images, []);
  ...
  useEffect(() => {
    ...
    const dataLayer_res = DataLayer({
      event: "over40GenderPageView",
      stage: "Over40 Gender Selection",
    });
  }, []);
  ...
  return (
    <div className="min-ht">
      ...
      <div className="bodly">
        ...
        <div className="tit">
          <h1>Personalized Keto Diet for People over 40 Get yours Now</h1>
        </div>
        ...
        <div className="slctndv-wrap">
          <Link
            className="male-btn"
            onClick={() => {
              storeClick(surveyItems.categoryItems[0].itemId);
            }}
            to={"/over40/how-familiar.html"}
          >
            <div className="slctndv">
              <div className="ml-slctn">
                <img
                  src={over40_images["men_over40"]}
                  alt="Loading.."
                  loading="lazy"
                  width={149}
                  height={139}
          ...
          >
            <div className="slctndv">
              <div className="wmn-slctn">
                <img
                  src={over40_images["women_over40"]}
                  alt="Loading.."
                  loading="lazy"
                  width={149}
                  height={139}
...
export default React.memo(Over40);
